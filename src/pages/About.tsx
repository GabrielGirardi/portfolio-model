        ...
        <div className="max-w-4xl mx-auto">
            ...
            <Card>
                ...
                <CardContent>
                    <p className="mb-4">
                        {language === 'pt'
                            ? 'Com mais de 5 anos de experiência em suporte técnico, tenho ajudado empresas a melhorar seus processos de atendimento ao cliente e resolver problemas técnicos complexos.'
                            : 'With over 5 years of experience in technical support, I have been helping companies improve their customer service processes and solve complex technical issues.'}
                    </p>
                    <p>
                        {language === 'pt'
